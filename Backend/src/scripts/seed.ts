...
export const productsData = [
  ...
  },
  {
    ...
    description: "The ultimate celebratory dry fruit collection. Includes Iranian Mamra Almonds, Royal Medjool King Dates, Dried Kandahar Figs, and Wild Berry Mix housed in an embossed presentation box.",
    serving: "1.2kg Gold Gift Box",
    origin: "Grand Selection",
    grade: "Royal Edition",
    benefits: ["Gold Embossed Finish", "Air-tight Lock", "Guaranteed Premium Grade"],
    bestseller: false,
    isNew: true,
    isNewProduct: true,
    stock: 50,
