  ...
  head: () => ({
    meta: [
      { title: "Viśvam — Everyday indulgence in the finest dry fruits & nuts" },
      {
        name: "description",
        content:
          "Explore single-origin California Jumbo Almonds, W240 Whole Cashews, Kashmiri Extra-Light Walnuts, Figs, and Medjool Dates delivered nationwide.",
      },
      {
        name: "keywords",
        content:
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 bg-sand/40">
        ...
        <div className="p-10 lg:p-20 flex flex-col justify-center">
          ...
          <p className="text-sm leading-relaxed text-muted-foreground max-w-md mb-10">
            From the sun-drenched almond groves of California to the high mountain terraces of Kandahar, every single kernel in our collection is handpicked at peak oil maturity, sorted by size and grade, and preserved with care.
          </p>
          <Link
            to="/story"
        ...
        <div className="max-w-[1400px] mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="bg-cream aspect-[5/4] relative overflow-hidden group">
            ...
            <div className="absolute top-5 left-5 flex flex-col gap-2">
              ...
              <span className="bg-white text-ink text-[9px] tracked px-3 py-1 font-semibold uppercase">Bespoke Casket</span>
            </div>
          </div>
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-8 leading-relaxed max-w-md">
              An opulent presentation box featuring four individual compartments of California Jumbo Almonds, W240 Cashews, Kashmiri Walnut Halves, and Roasted Pistachios.
            </p>
